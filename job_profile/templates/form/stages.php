    ...
    <div class="tasc-list__table">
        <div class="tasc-list__th">
            ...
            <div class="col-4">
                <div class="tr-flex2">
                    <div>Статус</div>
                    <div class="nowrap">Изменение статуса</div>
                </div>
            </div>
        </div>
        ...
        <div class="tasc-list__tr" v-for="stage in stages" :data-id="stage.ID" v-if="allowedChangeStages || (stage.CHECKED === 'Y')">
            ...
            <div class="col-4">
                <div class="tr-flex">
                    ...
                    <template v-else-if="stage.CAN_CHANGE_RESPONSIBLE === 'Y'">
                    ...
                    <renins-button class="xs" style="float: right;" @click="editStageFormData.TITLE = 'Изменить согласующего'; showStageModal(stage)" :disabled="isStageUpdating(stage.ID)"
                        v-if="stage.RESPONSIBLE_USER && (stage.CAN_CHANGE_RESPONSIBLE === 'Y') && allowedChangeStages
                    ...
                    <renins-button v-if="stage.CAN_DELETE === 'Y' && allowedChangeStages" class="secondary xs" style="margin-left: 8px; float: right" @click="deleteAdditionStage(stage.ID)" :loading="isStageDeleting(stage.ID)">
